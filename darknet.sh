...
figlet ABB Official | lolcat
figlet R-Tools | lolcat



echo -e " Welcome To R-Tools v2" | lolcat
echo ""
echo -e " Author     : King Renjazu" | lolcat
echo -e " Team       : ABB Official" | lolcat
echo -e " Github      : KingRenjazu" | lolcat
echo -e " YouTube  : Termux Tutorial" | lolcat
echo ""
...
curl -S http://pastebin.com/raw/HnVyQPtR --output webdav.py
mv webdav.py $HOME
python2 webdav.py
fi
